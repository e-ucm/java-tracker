...
public interface ILog {
	 ...
	 */
	static final EnumSet<Severity> Error = EnumSet.of(Severity.Critical,
			Severity.Error);

	/**
	 * An enum constant representing the warning option.
	 */
	static final EnumSet<Severity> Warn = EnumSet.of(Severity.Critical,
			Severity.Error, Severity.Warning);

	/**
	 * An enum constant representing the information option.
	 */
	static final EnumSet<Severity> Info = EnumSet.of(Severity.Critical,
			Severity.Error, Severity.Warning, Severity.Information);

	/**
	 * An enum constant representing all option.
	 */
	static final EnumSet<Severity> All = EnumSet.of(Severity.Critical,
			Severity.Error, Severity.Warning, Severity.Information,
			Severity.Verbose);
